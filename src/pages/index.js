          ...
          <div className="container">
            <div className="row cards__container">
              <Card
                ...
                body={{
                  label:
                    "Start your journey with an overview of the EigenDA protocol",
                }}
              />
              ...
              <Card
                ...
                body={{
                  label:
                    "Learn how EigenDA works by dispersing and retrieving a blob on the command line",
                }}
              />
              ...
              <Card
                ...
                body={{
                  label:
                    "Ready to launch a rollup on EigenDA? Get started here",
                }}
              />
              ...
              <Card
                ...
                body={{
                  label:
                    "These pages document the details of how to integrate with EigenDA",
                }}
              />
              ...
              <Card
                ...
                body={{
                  label:
                    "EigenDA Mainnet will soon be permissionless; until then please register here to launch your rollup",
                }}
              />
            </div>
          </div>
