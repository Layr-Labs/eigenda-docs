...
<Tabs groupId="network">
  <TabItem value="mainnet" label="Mainnet">
    ...
    Note: EigenDA maintains two [quorums](https://docs.eigenlayer.xyz/eigenlayer/operator-guides/operator-introduction#quorums) on Mainnet: Restaked ETH (including Native and LST Restaked ETH) and EIGEN. EigenDA allows the Operator to opt-in to either quorum or both quorums at once (aka dual-quorum).
...
## Update Node Sockets
Updates ode Sockets due to any changes in the node network 
In the case of changes to the node network 

Ex: 
- Ports for dispersal or retrieval have been modified
