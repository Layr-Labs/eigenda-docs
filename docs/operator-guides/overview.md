...
This guide contains the steps needed to set up your node on the EigenDA Holesky testnet.
The Holesky testnet is used to test the operational and performance requirements for
running a node before deploying on mainnet. The Holesky testnet is under constant stress
...
Current mainnet operators running v1 must follow the [Blazar migration guide](./blazar-migration.md) to update their nodes to v2.
